...
RegisterNetEvent('ak47_cannabiscafe:openbossaction')
AddEventHandler('ak47_cannabiscafe:openbossaction', function()
...
RegisterNetEvent('ak47_cannabiscafe:notify')
AddEventHandler('ak47_cannabiscafe:notify', function(msg)
    ESX.ShowNotification(msg)
end)

RegisterNetEvent('ak47_cannabiscafe:progress')
AddEventHandler('ak47_cannabiscafe:progress', function(msg, time)
