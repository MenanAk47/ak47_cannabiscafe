...
RegisterServerEvent('ak47_cannabiscafe:PlayWithinDistance')
AddEventHandler('ak47_cannabiscafe:PlayWithinDistance', function(coords , maxDistance, soundFile)
    TriggerClientEvent('ak47_cannabiscafe:PlayWithinDistance', -1, coords, maxDistance, soundFile)
end)